![girl with flower and text "umejs"](https://ume.dantenl.com/media/images/umejs_banner.png)

# ume.js

[![npm version](https://img.shields.io/npm/v/%40dantenl%2Fumejs?style=for-the-badge)](https://www.npmjs.com/package/@dantenl/umejs)

umejs (short for **u**nnamed **m**arkdown **e**ngine) is a small little project that you can slot into Express to automagically convert Markdown files into a static website. It's easy to set up for any existing project or to create a new project, for example a blog. It's quite small, but at the same time very flexible.

If you want to see a site generated by ume, check out [the documentation](https://ume.dantenl.com).
